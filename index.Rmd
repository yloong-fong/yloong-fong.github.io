...
par(mar=rep(0, 4))
plot.new()
text(x=0.5, y=0.5, "Extreme Right Wing")
...
plot.new()
text(x=0.5, y=0.5, "Extreme Left Wing")
...
plot.new()
text(x=0.5, y=0.5, "Ethno-Nationalist/Separatist")
...
The founding philosophy describes the group's mission, raison d'??tre and epistemological concerns. To investigate the similarities and differences in missions across the ideologies, the word clouds above show the most frequent terms used in describing the founding philosophies of different idologies, colour coded by ideology type.

Comparing the terms used in the founding philosophy across the 5 dominant ideologies, there appears to be common terms like "attack", "government", "political" and "revolutionaries" across most of the groups, suggesting certain common missions of political change as suggested by these terms. On the other hand, some groups have more similar focus like "struggle" and "action" used more commonly for Extreme Right Wing and Religious, where these groups may adopt more active philosophies. The Extreme Right Wing, Religious and Ethno-Nationalist/Separatist may also have similar focus on racial issues with frequent terms like "jewish", "black" and "white", suggestive of possible groups sparked by racial discontent.
